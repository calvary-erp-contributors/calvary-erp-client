...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './sales-receipt-proposal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALESRECEIPTPROPOSAL_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SALESRECEIPTPROPOSALS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SALESRECEIPTPROPOSAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SALESRECEIPTPROPOSAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SALESRECEIPTPROPOSAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SALESRECEIPTPROPOSAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SALESRECEIPTPROPOSAL actions', async () => {
      const expectedActions = [
        {
