...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './sales-receipt-email-persona.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALESRECEIPTEMAILPERSONA_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SALESRECEIPTEMAILPERSONAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SALESRECEIPTEMAILPERSONA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SALESRECEIPTEMAILPERSONA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SALESRECEIPTEMAILPERSONA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SALESRECEIPTEMAILPERSONA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SALESRECEIPTEMAILPERSONA actions', async () => {
      const expectedActions = [
        {
