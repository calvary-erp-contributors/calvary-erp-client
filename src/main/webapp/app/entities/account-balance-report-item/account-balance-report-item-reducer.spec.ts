...
import reducer, { getEntities, searchEntities, getEntity, reset } from './account-balance-report-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTBALANCEREPORTITEM_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ACCOUNTBALANCEREPORTITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ACCOUNTBALANCEREPORTITEM actions', async () => {
      const expectedActions = [
        {
