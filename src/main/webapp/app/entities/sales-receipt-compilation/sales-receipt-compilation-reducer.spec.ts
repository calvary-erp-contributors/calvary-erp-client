...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './sales-receipt-compilation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALESRECEIPTCOMPILATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SALESRECEIPTCOMPILATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SALESRECEIPTCOMPILATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SALESRECEIPTCOMPILATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SALESRECEIPTCOMPILATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SALESRECEIPTCOMPILATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SALESRECEIPTCOMPILATION actions', async () => {
      const expectedActions = [
        {
