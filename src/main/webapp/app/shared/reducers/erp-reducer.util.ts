...
export interface ERPEntityState<T> {
  loading: boolean;
 ...
 */
export const createEntitySlice = <T, Reducers extends SliceCaseReducers<ERPEntityState<T>>>({
  name = '',
  initialState,
  reducers,
  extraReducers,
  ...
  name: string;
  initialState: ERPEntityState<T>;
  reducers?: ValidateSliceCaseReducers<ERPEntityState<T>, Reducers>;
  extraReducers?: (builder: ActionReducerMapBuilder<ERPEntityState<T>>) => void;
