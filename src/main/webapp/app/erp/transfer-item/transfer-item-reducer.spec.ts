...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSFERITEM_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TRANSFERITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TRANSFERITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSFERITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSFERITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSFERITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSFERITEM actions', async () => {
      const expectedActions = [
        {
