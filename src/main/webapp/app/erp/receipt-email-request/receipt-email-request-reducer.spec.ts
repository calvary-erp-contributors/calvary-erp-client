...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './receipt-email-request.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECEIPTEMAILREQUEST_LIST actions', async () => {
    ...
    it('dispatches SEARCH_RECEIPTEMAILREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_RECEIPTEMAILREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RECEIPTEMAILREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RECEIPTEMAILREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RECEIPTEMAILREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RECEIPTEMAILREQUEST actions', async () => {
      const expectedActions = [
        {
