...
import transactionAccount from 'app/erp/transaction-account-management/transaction-account/transaction-account.reducer';
import transactionEntry from 'app/erp/transaction-account-management/transaction-entry/transaction-entry.reducer';
import accountTransaction from 'app/erp/transaction-account-management/account-transaction/account-transaction.reducer';
...
import transactionAccountType from 'app/erp/transaction-account-management/transaction-account-type/transaction-account-type.reducer';
import transactionCurrency from 'app/erp/transaction-account-management/transaction-currency/transaction-currency.reducer';
...
import accountBalanceReportItem from './transaction-account-management/account-balance-report-item/account-balance-report-item.reducer';
