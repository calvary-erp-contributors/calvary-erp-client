...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './transaction-account.reducer';
import { EntityState } from '../../../shared/reducers/reducer.utils';
import { ITransactionAccount, defaultValue } from '../../../shared/model/transaction-account.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSACTIONACCOUNT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TRANSACTIONACCOUNTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TRANSACTIONACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSACTIONACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSACTIONACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSACTIONACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSACTIONACCOUNT actions', async () => {
      const expectedActions = [
        {
