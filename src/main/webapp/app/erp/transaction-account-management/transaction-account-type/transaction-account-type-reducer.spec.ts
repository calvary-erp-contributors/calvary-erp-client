...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './transaction-account-type.reducer';
import { EntityState } from '../../../shared/reducers/reducer.utils';
import { ITransactionAccountType, defaultValue } from '../../../shared/model/transaction-account-type.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSACTIONACCOUNTTYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TRANSACTIONACCOUNTTYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TRANSACTIONACCOUNTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSACTIONACCOUNTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSACTIONACCOUNTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSACTIONACCOUNTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSACTIONACCOUNTTYPE actions', async () => {
      const expectedActions = [
        {
